...
You can see that, compared to the previous example, the complete _execution of the action was reduced from 1m 11s to 13s_. It **was reduced by 90%.**
...
And, because this image is smaller, it can be downloaded faster, which means: _Faster startup times!_
